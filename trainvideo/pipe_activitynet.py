...
def gen_caption(video_path):
    ...
    # video_path = "/mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/Y6R7T.mp4"
    ...
    # # 保存为 JSON 文件
    with open(f'/mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/activitynet/anno/struct_caption_{save_name}.json', 'w', encoding='utf-8') as f:
...
def qa_pipe(video_path, event_list):
    save_name = os.path.basename(video_path).split('.')[0]
    # # 保存为 JSON 文件
    if os.path.exists(f'/mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/activitynet/anno/struct_caption_{save_name}.json'):
        return
    ...
    result_str = chat_text(query, "doubao-seed-1.6-250615")
    ...
    save_name = os.path.basename(video_path).split('.')[0]
    # 保存为 JSON 文件
    with open(f'/mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/activitynet/anno/grounding_2QA_{save_name}.json', 'w', encoding='utf-8') as f:
        json.dump(result_dict, f, indent=4, ensure_ascii=False)

if __name__ == "__main__":
    # read data from json file
    with open('/mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/activitynet/train_filter.json', 'r', encoding='utf-8') as f:
