...
# model_ori = "/mnt/bn/wxd-video-understanding/wangxd/ckpt/Qwen25-SFT-Time-GRPO/Qwen2.5-VL-7B-Instruct-Mix-data-no-pad-fix-zero3-offload-0711-N3-TGRPO-Edit-fix-time/checkpoint-400"

model_path = "/mnt/bn/wxd-video-understanding/wangxd/ckpt/Qwen2.5-VL-Finetune-Zoomin-SFT/Qwen2.5-VL-7B-Instruct-zero3-offload-mix_sft_data_new_0720-N2/"

model_path = "/mnt/bn/wxd-video-understanding/wangxd/ckpt/Qwen25-SFT-Time-GRPO/Qwen2.5-VL-7B-Instruct-f80-GRPO-clip-iou-charades-9k-max80-ratio-0721-N2/checkpoint-550"

# model_path = "/mnt/bn/wxd-video-understanding/wangxd/ckpt/Qwen25-SFT-Keyitem-GRPO/Qwen2.5-VL-7B-Instruct-f80-TGRPO-step500-GRPO-keyitems-max80-0721-N1-1e-6/checkpoint-250"
...
image_inputs, video_inputs, _, video_kwargs = process_vision_info(messages, return_video_kwargs=True)
inputs = processor(
    text=[text],
    videos=video_inputs,
    padding=True,
