...
# with open("/mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/trainvideo/test_charades_val_all_for_ours.json", "w") as f:
...
our_pred = []
with open("our_pred_reverse.jsonl", "w") as f:
...
# with open('our_pred.json', 'w') as f:
