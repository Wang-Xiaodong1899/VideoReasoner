...
model_path = "/mnt/bn/wxd-video-understanding/wangxd/ckpt/Qwen2-SFT-Mix-GRPO-IoU-Acc/Qwen2VL-7B-Instruct-f80-Mix-SFT-0911-N2-GQA-iou-acc-R8-0916/checkpoint-100"

model_path = "/mnt/bn/wxd-video-understanding/wangxd/ckpt/Qwen2-SFT-Mix-GRPO-IoU-Acc/Qwen2VL-7B-Instruct-f80-Mix-SFT-0911-N2-GQA-iou-acc-R8-0916-back/checkpoint-300"
...
for _ in range(2):
    # Inference
    generated_ids = model.generate(**inputs, max_new_tokens=512, do_sample=True, temperature=2.0, use_cache=True)
