...
# embeddings_dir = "/mnt/bn/wxd-video-understanding/wangxd/eval/Open-R1-Video-V1/eval/pe_embeddings/longvideobench_f768"

embeddings_dir = "/mnt/bn/wxd-video-understanding/wangxd/eval/Open-R1-Video-V1/eval/pe_embeddings/videoevalpro_mcq_f768"
...
videomme_csv = "/mnt/bn/wxd-video-understanding/wangxd/repo/benchmark-video-llms-eval/videoevalpro_mcq_noprefix-keyframes-0920.csv"
...
with open(f"0924_videoevalpro_f768_ours_segment_query{max_select_items}_seg{segment_len}_topk{query_k}_index.json", "w") as f:
    json.dump(save_data, f, indent=4, ensure_ascii=False)