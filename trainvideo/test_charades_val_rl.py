...
model_path = "/mnt/bn/wxd-video-understanding/wangxd/ckpt/Qwen25-SFT-Time-GRPO/Qwen2.5-VL-7B-Instruct-Charades-f80-sft3k-GRPO-clip-iou-9k-max80-percentage-0709-N2/checkpoint-600"
...
our_pred = []
with open("our_rl_600_pred_100.jsonl", "w") as f:
...
with open('our_rl_600_pred_100.json', 'w') as f:
