...
videomme_csv = "/mnt/bn/wxd-video-understanding/wangxd/repo/benchmark-video-llms-eval/longvideobench_noprefix-keyframes-0920.csv"
...
with open(f"0924_longvideobench_f768_ours_segment_query{max_select_items}_seg{segment_len}_topk{query_k}_index.json", "w") as f:
    json.dump(save_data, f, indent=4, ensure_ascii=False)