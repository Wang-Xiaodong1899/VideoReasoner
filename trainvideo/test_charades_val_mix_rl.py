...
model_path = "/mnt/bn/wxd-video-understanding/wangxd/ckpt/Qwen25-SFT-Time-GRPO/Qwen2.5-VL-7B-Instruct-Mix-data-no-pad-zero3-offload-0711-N3-TGRPO-Edit-fix-time/checkpoint-150"
...
with open("/mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/trainvideo/test_charades_val_for_ours_sft.json", "r") as f:
    test_data = json.load(f)

our_pred = []
with open("our_mix_rl_150_VMax768_pred_100_fix_max.jsonl", "w") as f:
...
with open('our_mix_rl_150_VMax768_pred_100_fix_max.json', 'w') as f:
