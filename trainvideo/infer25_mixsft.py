...
model_path = "/mnt/bn/wxd-video-understanding/wangxd/ckpt/Qwen2.5-VL-Finetune-Zoomin-SFT/Qwen2.5-VL-7B-Instruct-Charades_v1-SFT-Video-Zoomin-3k-ep2-videoP80F64-percentage-no-event-continue-event-ep2-N1-0709-zero3-offload/"

model_path = "/mnt/bn/wxd-video-understanding/wangxd/ckpt/Qwen2.5-VL-Finetune-Zoomin-SFT/Qwen2.5-VL-7B-Instruct-Charades_v1-SFT-Event-ep5-videoP80F64-percentage-zero3-offload-0709/checkpoint-300"
...
VIDEO_QUESTION_TEMPLATE = (
        "Give you a video. Please think about your reasoning before answering the question.\n"
        "First, consider whether the key event in the video needs to be located for better understanding.\n"
        "- If you believe it is necessary to locate the key event (e.g., due to unclear or complex content), please generate its location as a proportion of the video duration using the format: <|event_start|> [start_ratio, end_ratio] <|event_end|>, where start_ratio and end_ratio are floats between 0 and 1.\n"
        "  Then, use the <|video_zoomin|> tag to zoom in on the event content before reasoning.\n"
        "- If the video is already clear enough, you may proceed directly to reasoning without locating the event.\n"
        "Please present your thought process and answer using the following tags:\n"
