...
RUN_NAME=Qwen2VL-7B-Instruct-f${FPS_MAX_FRAMES}-Mix-SFT-0911-N2-GQA-iou-acc-format0d5-R8-0915
...
HF_DATASET=/mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/data/rl_data/filter_data/filter_GQA_qa_ground.json
