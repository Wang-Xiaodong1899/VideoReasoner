...
QWEN_PATH=/mnt/bn/multimodal-datasets-hl/wangxd/ckpt/Qwen2.5-VL-7B-Video-7B-f32-cot-sft/checkpoint-10000
HF_DATASET="/mnt/bn/ws-candy-hl-62827-yz89lqpbo2/data/Video-R1-data/Video-R1-260k-filter.json"
OUTPUT_DIR="/mnt/bn/multimodal-datasets-hl/wangxd/ckpt/Qwen2.5-VL-7B-SFT-Video-f32-GRPO"
if [ ! -d "$OUTPUT_DIR" ]; then
 mkdir -p "$OUTPUT_DIR"
fi
RUN_NAME="Qwen2.5-VL-7B-SFT-Video-f32-GRPO"
