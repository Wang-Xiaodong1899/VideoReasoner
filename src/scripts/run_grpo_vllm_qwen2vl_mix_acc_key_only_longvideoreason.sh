...
RUN_NAME=Qwen2VL-7B-Instruct-f${FPS_MAX_FRAMES}-Mix-GRPO-IoU-Acc-N2-Key-0908
...
HF_DATASET=/mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/data/rl_data/longvideoreason_qa_keyitem_7997.json
