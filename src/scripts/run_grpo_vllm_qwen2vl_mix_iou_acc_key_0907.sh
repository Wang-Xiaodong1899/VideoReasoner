...
RUN_NAME=Qwen2VL-7B-Instruct-f${FPS_MAX_FRAMES}-Mix-GRPO-IoU-Acc-add-Charades-Diverse-N2-0907
...
HF_DATASET=/mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/data/rl_data/GQA_ActivityNet_charades_longvideoreason_ground_qa_key_80279.json
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc_per_node="8" \
    --nnodes="2" \
    --node_rank=${RANK} \
    --master_addr="[2605:340:cd51:4900:7ffe:ffec:9575:94f3]" \
    --master_port="12352" \
    src/open_r1/grpo_mix_grpo.py \
    --reward_funcs accuracy iou diverse \
    --use_vllm false \
