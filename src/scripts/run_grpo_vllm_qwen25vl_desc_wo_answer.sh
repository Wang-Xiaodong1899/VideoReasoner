...
RUN_NAME=Qwen2.5-VL-7B-Instruct-Video-R1-f${FPS_MAX_FRAMES}-desc-sup-BERT-new-template-wo-answer-video-GRPO-MAX196-maxlen1024-14k-0510
...
CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7" torchrun \
    ...
    --master_port="12350" \
    src/open_r1/grpo_desc_sup_wo_answer.py \
    --use_vllm true \
