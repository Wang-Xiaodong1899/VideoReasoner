...
export WANDB_NAME=Qwen2-VL-7B-base-Video-R1-SFT-Video-desc
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc_per_node="8" \
    ...
    --master_port="12349" \
    src/open_r1/sft_desc_baseline.py \
    ...
    --dataset_name /mnt/bn/ws-candy-hl-62827-yz89lqpbo2/data/Video-R1-data/Video-R1-260k-filter-video-desc-32b-merge-0424.json \
