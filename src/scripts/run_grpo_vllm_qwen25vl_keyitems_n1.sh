...
RUN_NAME=Qwen2.5-VL-7B-Instruct-f${FPS_MAX_FRAMES}-18k-GRPO-keyitems-max80-0724-N1
...
QWEN_PATH=/mnt/bn/wxd-video-understanding/wangxd/ckpt/Qwen25-SFT-Time-GRPO/Qwen2.5-VL-7B-Instruct-f80-GRPO-clip-iou-charades-18k-max80-ratio-0721-N2/checkpoint-900
