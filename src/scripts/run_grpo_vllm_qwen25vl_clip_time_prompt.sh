...
export SWANLAB_NAME=Qwen2.5-VL-7B-Instruct-Mix-data-no-pad-TGRPO-Edit-fix-time-step300-Time-Prompt-Reasoning-GQA_Charade_ActivityNet-7k-0713-N2
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc_per_node="8" \
    --nnodes="2" \
    --node_rank=${RANK} \
    --master_addr="[2605:340:cd51:4900:a651:4693:829a:fc51]" \
    --master_port="12352" \
