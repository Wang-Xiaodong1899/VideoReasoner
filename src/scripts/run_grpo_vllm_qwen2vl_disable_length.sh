...
RUN_NAME=Qwen2-VL-Base-7B-SFT-Video-f32-GRPO-disable_length

cd src/r1-v

export DEBUG_MODE="true"
export LOG_PATH="./qwen2-vl-base-disable_length-vllm_run.txt"


QWEN_PATH=/mnt/bn/multimodal-datasets-hl/wangxd/ckpt/Qwen2-VL-7B-base-Video-7B-f32-cot-sft/checkpoint-5000
