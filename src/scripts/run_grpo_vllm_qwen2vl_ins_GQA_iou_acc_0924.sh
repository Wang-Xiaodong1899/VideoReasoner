...
RUN_NAME=Qwen2VL-7B-Instruct-f${FPS_MAX_FRAMES}-Mix-SFT-0911-N2-GQA-iou-acc-R8-Ins-0924

export LOG_PATH=./${RUN_NAME}.txt

QWEN_PATH=/mnt/bn/wxd-video-understanding/wangxd/ckpt/Qwen2-VL-Finetune-Zoomin-SFT/Qwen2-VL-7B-Ins-zero3-offload-mix_sft_data_new_0720-N2
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc_per_node="8" \
    --nnodes="2" \
    --node_rank=${RANK} \
    --master_addr="[2605:340:cd51:4900:9769:3dd3:5715:f7d8]" \
    --master_port="12352" \
