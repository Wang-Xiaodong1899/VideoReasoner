...
RUN_NAME=Qwen2VL-7B-Instruct-f${FPS_MAX_FRAMES}-Mix-GRPO-IoU-Acc-Diverse-N2-0906
...
HF_DATASET=/mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/data/rl_data/GQA_longvideoreason_ground_items_qa_61892.json
