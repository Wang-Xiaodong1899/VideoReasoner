...
export WANDB_NAME=Qwen2.5-VL-7B-Instruct-Charades_v1-SFT-Video-Zoomin-3k-ep5-videoP80F64-percentage-mix-no-event-N2-0708
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc_per_node="8" \
    ...
    --dataset_name /mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/data/sft_data/train_event_id_0_1k_query_time_latest_add_900_single_event_update_0708.json \
