#!/bin/bash
export WANDB_PROJECT=LLaVA-R1-GRPO-Project
...
RUN_NAME=Qwen2-VL-Base-7B-llavar1-SFT-1k-Video-f${FPS_MAX_FRAMES}-GRPO-no-std

export LOG_PATH=./${RUN_NAME}.txt

QWEN_PATH=/mnt/bn/multimodal-datasets-hl/wangxd/ckpt/Qwen2-VL-7B-base-Video-7B-f32-llava-r1-100k-sft-full-back/checkpoint-6000/
