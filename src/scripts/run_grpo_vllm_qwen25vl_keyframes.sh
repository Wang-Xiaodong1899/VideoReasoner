...
RUN_NAME=Qwen2.5-VL-7B-Instruct-Charades-f${FPS_MAX_FRAMES}-sft3k-GRPO-keyframe-0705

export LOG_PATH=./${RUN_NAME}.txt


QWEN_PATH=/mnt/bn/wxd-video-understanding/wangxd/ckpt/Qwen2.5-VL-Finetune-llava-178k-SFT/Qwen2.5-VL-7B-Instruct-llava-178k-SFT-Video-Keyframes-Max300-F128
HF_DATASET=/mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/trainvideo/Video-R1-kyframes-GRPO-max64.json
