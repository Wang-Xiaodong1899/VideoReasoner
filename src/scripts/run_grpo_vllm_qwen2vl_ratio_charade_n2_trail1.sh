#!/bin/bash
export SWANLAB_PROJECT=Qwen2-SFT-Time-GRPO
...
RUN_NAME=Qwen2VL-7B-Instruct-f${FPS_MAX_FRAMES}-GRPO-clip-iou-charades-18k-max80-ratio-0721-N2-trail1
...
# HF_DATASET=/mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/data/rl_data/charades_find_query_train_grpo_iou_only.json
HF_DATASET=/mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/data/rl_data/charades_find_query_train_grpo_iou_only_prefix.json
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc_per_node="8" \
    ...
    --master_port="12352" \
    src/open_r1/grpo_clip_tgrpo_0720.py \
    --use_vllm false \
