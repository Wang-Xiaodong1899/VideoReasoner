...
RUN_NAME=Qwen2.5-VL-7B-Instruct-Video-R1-f${FPS_MAX_FRAMES}-desc-new-template-wo-answer-think-video-GRPO-MAX196-maxlen1024-14k-0507

export LOG_PATH=./${RUN_NAME}.txt

# QWEN_PATH=/mnt/bn/multimodal-datasets-hl/wangxd/models/Qwen2.5-VL-7B-Instruct
QWEN_PATH=/mnt/bn/multimodal-datasets-hl/wangxd/ckpt/Qwen2.5-VL-7B-Instruct-Video-R1-f32-desc-sup-BERT-new-template-wo-answer-video-GRPO-MAX196-maxlen1024-14k-0507/checkpoint-400
