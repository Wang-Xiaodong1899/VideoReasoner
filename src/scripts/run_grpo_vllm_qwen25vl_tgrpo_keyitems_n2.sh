...
RUN_NAME=Qwen2.5-VL-7B-Instruct-f${FPS_MAX_FRAMES}-TGRPO-step500-GRPO-keyitems-max80-0721-N2

export LOG_PATH=./${RUN_NAME}.txt


QWEN_PATH=/mnt/bn/wxd-video-understanding/wangxd/ckpt/Qwen25-SFT-Time-GRPO/Qwen2.5-VL-7B-Instruct-f80-GRPO-clip-iou-charades-9k-max80-ratio-0721-N2/checkpoint-500
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc_per_node="8" \
    --nnodes="2" \
    --node_rank=${RANK} \
    --master_addr="[2605:340:cd51:4900:2a75:4abd:38b4:556b]" \
    --master_port="12352" \
