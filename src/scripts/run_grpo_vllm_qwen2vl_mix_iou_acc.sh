...
RUN_NAME=Qwen2VL-7B-Instruct-f${FPS_MAX_FRAMES}-Mix-GRPO-IoU-Acc-N2-0906
...
HF_DATASET=/mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/data/rl_data/GQA_longvideoreason_ground_qa_36178.json
