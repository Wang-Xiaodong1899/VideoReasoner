...
# stage-2 multi-task GRPO ablation
...
RUN_NAME=Qwen2VL-7B-Instruct-f${FPS_MAX_FRAMES}-Mix-SFT-0911-N2-GQA-iou-acc-R8-0916-ablate-iou-only

export LOG_PATH=./${RUN_NAME}.txt

QWEN_PATH=/mnt/wxd/wangxd/ckpt/Qwen2-VL-Finetune-Zoomin-SFT/Qwen2-VL-7B-zero3-offload-mix_sft_data_new_0720-N2

HF_DATASET=/mnt/wxd/wangxd/VideoReasoner/data/rl_data/filter_data/filter_GQA_ground_ablate.json
