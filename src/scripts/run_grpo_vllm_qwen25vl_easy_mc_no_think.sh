...
RUN_NAME=Qwen2.5-VL-7B-Instruct-Video-R1-video-easy-nothink-f${FPS_MAX_FRAMES}-GRPO-traj8-0528

export LOG_PATH=./${RUN_NAME}.txt


QWEN_PATH=/mnt/bn/multimodal-datasets-hl/wangxd/models/Qwen2.5-VL-7B-Instruct
HF_DATASET=/mnt/bn/ws-candy-hl-62827-yz89lqpbo2/data/Video-R1-data/Video-R1-260k-filter-video-90423-qa-qwen2vl-0-32000_filter.json
