...
RUN_NAME=Qwen2-VL-Base-7B-Video-R1-f${FPS_MAX_FRAMES}-desc-sup-new-template-video-GRPO-MAX196-maxlen1024-merge-0424-2node
...
CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7" torchrun \
    ...
    --nnodes="2" \
    --node_rank=${RANK} \
    --master_addr="[2605:340:cd51:4900:cd12:e237:77c7:236]" \
    --master_port="12350" \
    src/open_r1/grpo_desc_sup.py \
    --use_vllm true \
