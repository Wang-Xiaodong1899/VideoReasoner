...
RUN_NAME=Qwen2.5-VL-7B-Instruct-Charades-Activity-f${FPS_MAX_FRAMES}-sft3k-GRPO-clip-iou-max80-percentage-0708-N2

export LOG_PATH=./${RUN_NAME}.txt


QWEN_PATH=/mnt/bn/wxd-video-understanding/wangxd/ckpt/Qwen2.5-VL-Finetune-Zoomin-SFT/Qwen2.5-VL-7B-Instruct-Charades_v1-SFT-Video-Zoomin-3k-ep5-videoP80F64-N2-percentage-0706/
HF_DATASET=/mnt/bn/wxd-video-understanding/wangxd/Open-R1-Video-Mix/activitynet/train_grpo_solution_Charades_v1_activitynet_0704.json
