...
RUN_NAME=Qwen2-VL-Base-7B-f${FPS_MAX_FRAMES}-free-video-GRPO-MAX196-maxlen1024-14k-0504

export LOG_PATH=./${RUN_NAME}.txt

QWEN_PATH=/mnt/bn/multimodal-datasets-hl/wangxd/models/Qwen2-VL-7B
...
HF_DATASET=/mnt/bn/ws-candy-hl-62827-yz89lqpbo2/data/Video-R1-data/Video-R1-260k-filter-video-14k.json # only video data
...
# HF_DATASET=/mnt/bn/ws-candy-hl-62827-yz89lqpbo2/data/Video-R1-data/Video-R1-260k-filter-video-desc-32b-merge-0424.json
