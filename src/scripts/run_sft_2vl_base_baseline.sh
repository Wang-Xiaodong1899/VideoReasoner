...
export WANDB_NAME=Qwen2-VL-7B-base-Video-R1-SFT-Video-data
...
CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node="1" \
    ...
    --dataset_name /mnt/bn/ws-candy-hl-62827-yz89lqpbo2/data/Video-R1-data/Video-R1-260k-filter-video.json \
