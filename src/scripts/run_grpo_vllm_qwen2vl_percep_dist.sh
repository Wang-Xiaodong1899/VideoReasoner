#!/bin/bash
export WANDB_PROJECT=Video-R1-Perception
...
RUN_NAME=Qwen2-VL-Base-7B-Video-R1-f${FPS_MAX_FRAMES}-percept-only-GRPO-MAX196-maxlen1024-2node
...
CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7" torchrun \
    ...
    --nnodes="2" \
    --node_rank=${RANK}  \
    --master_addr="[2605:340:cd51:4900:3894:7fde:28c5:edfa]" \
    --master_port="12350" \
    src/open_r1/grpo_percep.py \
    --use_vllm true \
