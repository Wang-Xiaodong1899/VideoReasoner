...
export SWANLAB_NAME=Qwen2.5-VL-7B-Instruct-Charades_v1-SFT-Event-ep5-videoP80F64-percentage-keyframes-ep5-TGRPO

export DEBUG_MODE="true" # Enable Debug if you want to see the rollout of model during RL
export LOG_PATH="./${SWANLAB_NAME}.txt"

QWEN_PATH=/mnt/bn/wxd-video-understanding/wangxd/ckpt/Qwen2.5-VL-Finetune-Zoomin-SFT/Qwen2.5-VL-7B-Instruct-Charades_v1-SFT-Event-ep5-videoP80F64-percentage-keyframes-ep5-zero3-offload-0710/
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc_per_node="7" \
    ...
    --master_port="12352" \
    src/open_r1/grpo_clip_tgrpo.py \
    --use_vllm true \
