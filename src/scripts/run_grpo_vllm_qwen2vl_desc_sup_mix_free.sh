...
RUN_NAME=Qwen2-VL-Base-7B-f${FPS_MAX_FRAMES}-desc-sup-BERT-new-template-mix-free-video-GRPO-MAX196-maxlen1024-merge-0424
...
CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7" torchrun \
    ...
    --master_port="12350" \
    src/open_r1/grpo_desc_sup_mix_free.py \
    --use_vllm true \
