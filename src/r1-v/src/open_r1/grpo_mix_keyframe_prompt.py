...
from trainer import Qwen2VLGRPOTrainerClipKeyFramePrompt, Qwen2VLGRPOVLLMTrainerModifiedKeyFrame
...
def main(script_args, training_args, model_args):
    ...
    trainer_cls = Qwen2VLGRPOTrainerClipKeyFramePrompt if not training_args.use_vllm else Qwen2VLGRPOVLLMTrainerModifiedKeyFrame
