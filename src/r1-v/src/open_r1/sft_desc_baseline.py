...
def prepare_dataset(example: Dict[str, Any]) -> Dict[str, List[Dict[str, Any]]]:
    ...
    system_message = "You are a very smart multimodal assistant that can understand images and videos. Please answer the user's questions. "
    ...
    messages = [
        ...
        {
            "role": "assistant",
            "content": [{"type": "text", "text": example['desc'] + " " + example['solution']}]
        }
    ]
