...
def prepare_dataset(example: Dict[str, Any]) -> Dict[str, List[Dict[str, Any]]]:
    ...
    QUESTION_TEMPLATE = (
        "Given the image to you. Please answer the following question:\n"
        "{Question}\n"
...
def collate_fn(examples: List[Dict[str, Any]]) -> Dict[str, torch.Tensor]:
    ...
    for i, example in enumerate(examples):
        try:
            ...
            image_inputs, video_inputs, _, _, video_kwargs = process_vision_info(example["messages"], return_video_kwargs=True)
