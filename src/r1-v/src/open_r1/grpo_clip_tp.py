...
from trainer import Qwen2VLGRPOTrainerClipTP, Qwen2VLGRPOVLLMTrainerModifiedKeyFrame
...
def main(script_args, training_args, model_args):
    ...
    trainer_cls = Qwen2VLGRPOTrainerClipTP if not training_args.use_vllm else Qwen2VLGRPOVLLMTrainerModifiedKeyFrame
