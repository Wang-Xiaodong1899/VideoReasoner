...
def main(script_args, training_args, model_args):
    ...
    VIDEO_QUESTION_TEMPLATE = (
        ...
        "Your thinking process is enclosed within <think> </think> and include a final answer in boxed format, i.e., <think> reasoning process here </think> conclusion process \\boxed{{final answer}}."
    )
