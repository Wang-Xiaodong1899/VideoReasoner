...
from trainer import Qwen2VLGRPOTrainer, Qwen2VLGRPOVLLMTrainerModifiedKeyFrame
...
def main(script_args, training_args, model_args):
    ...
    def make_conversation_image_and_video(example):
        ...
        msg ={
                    ...
                    "content": [
                        {
                            "type": "video",
                            "video": example['path'],
                            "max_pixels": 128*28*28, #150*28*28,
                            "fps": 1.0,
                            "max_frames": 64 #48 #32
                        },
                        {
            ...
            "keyframe_indices_list": example['keyframe_indexs'],
    ...
    trainer_cls = Qwen2VLGRPOTrainer if not training_args.use_vllm else Qwen2VLGRPOVLLMTrainerModifiedKeyFrame
