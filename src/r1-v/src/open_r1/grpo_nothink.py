...
def main(script_args, training_args, model_args):
    ...
    VIDEO_QUESTION_TEMPLATE = (
        ...
        "{Question}\n"
        "Your response is enclosed within <no_think> </no_think> and include a final answer in boxed format, i.e., <no_think> simple analysis process \\boxed{{final answer}} </no_think>. "
    )
