...
model_path = "/mnt/wxd/wangxd/models/Qwen2-VL-7B-Instruct"


model_path = "/mnt/wxd/wangxd/ckpt/Qwen2-VL-Finetune-Zoomin-SFT/Qwen2-VL-7B-zero3-offload-mix_sft_data_new_0720-N2/"
...
"""
path = "/mnt/wxd/wangxd/VideoReasoner/assets/lokFoo_QD8c.mp4"

# query = """
# What kind of hat does the little boy wear?
# A. Cowboy hat B. Beret C. Baseball cap D. Top hat
# """
# path = "/mnt/wxd/wangxd/dataset/LVBench/all_videos/-hgaSElC3wU.mp4"

# query = """
# How many red socks are above the fireplace at the end of this video?
# A. 1 B. 4 C. 2 D. 3
# """
# path =  "/mnt/wxd/wangxd/VideoReasoner/assets/fFjv93ACGo8.mp4"
